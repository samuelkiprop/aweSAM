...
class Settings:
    def __init__(self):
        ...
        self.screen_name = "Tetris by Sam"
        ...
        self.start = "Hi, Sam :-)\nPress any key to start, press A to watch AI play"
        ...
        self.game_over = "You lost sucker... Press any key to play again, press A to watch AI play"
